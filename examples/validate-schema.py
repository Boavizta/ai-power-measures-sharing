...
registry = Registry().with_resources(
    [
        ("https://github.com/Boavizta/ai-power-measures-sharing/blob/feature/hackathon/model/algorithm_schema.json", algo_sch),
        ("https://github.com/Boavizta/ai-power-measures-sharing/blob/feature/hackathon/model/dataset_schema.json", data_sch),
        ("https://github.com/Boavizta/ai-power-measures-sharing/blob/feature/hackathon/model/measure_schema.json", meas_sch),
        ("https://github.com/Boavizta/ai-power-measures-sharing/blob/feature/hackathon/model/hardware_schema.json",hard_sch),
        ("https://github.com/Boavizta/ai-power-measures-sharing/blob/feature/hackathon/model/inference_schema.json", infe_sch),
    ],
)
...
if(validator.is_valid(instance)):
    ...
    print(bcolors.FAIL,"The json file does not correspond to the schema, there are ", sum(1 for x in validator.iter_errors(instance)),"errors :", bcolors.ENDC)
